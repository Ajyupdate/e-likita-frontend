export default function Home() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
      <section className="max-w-6xl mx-auto px-6 py-20">
        <div className="text-center">
          ...
          <h1 className="mt-6 text-5xl sm:text-6xl font-bold tracking-tight bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">
          ...
          <div className="mt-10 flex items-center justify-center gap-6">
            <a href="/consultation" className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105">
      ...
      <section id="features" className="border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900/50">
